 ...
 */
public class BaseModelIncidencia extends BaseModel{
    public BaseModelIncidencia(int Id,String Nombre) {
        setId(Id);
        setNombre(Nombre);
    }
    public BaseModelIncidencia(){}
    public int getId() {
    ...
    public ModeloTipoIncidencia getModeloDatos(){
        ModeloTipoIncidencia ModeloDatos = new ModeloTipoIncidencia();
