 ...
 */
public class VentanaImpresionFoliosXUnidadXDiagnosticosFinales{
    UIUnidad UIUnidad;
    ...
    public VentanaImpresionFoliosXUnidadXDiagnosticosFinales(RPCImpresionAsync RPCImpresion,RPCUnidadAsync RPCUnidad){
    ...
    private class EVENTO_BOTON extends SelectionListener<ButtonEvent>{
        ...
        public void componentSelected(ButtonEvent ce){
            RPCImpresion.RPTFoliosXUnidadXDiagnosticosFinales(modeloUnidad.getId(),new RETORNO_EVENTO_AGREGAR_EDITAR_ELIMIANR());
        }
    }
    private class RETORNO_EVENTO_AGREGAR_EDITAR_ELIMIANR implements AsyncCallback<Void>{
        public void onSuccess(Void result) {
            Visor.show("ServletFoliosXUnidadXDiagnosticosFinales");
            window.hide();
        }
