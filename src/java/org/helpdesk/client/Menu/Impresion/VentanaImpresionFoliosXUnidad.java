 ...
 */
public class VentanaImpresionFoliosXUnidad{
    UIUnidad UIUnidad;
    ...
    public VentanaImpresionFoliosXUnidad(RPCImpresionAsync RPCImpresion,RPCUnidadAsync RPCUnidad){
        ...
        window.setHeading("Reporte de Folios X Unidad");
    ...
    private class EVENTO_BOTON extends SelectionListener<ButtonEvent>{
        ...
        public void componentSelected(ButtonEvent ce){
            RPCImpresion.RPTFoliosXUnidad(modeloUnidad.getId(),new RETORNO_EVENTO_AGREGAR_EDITAR_ELIMIANR());
        }
    }
    private class RETORNO_EVENTO_AGREGAR_EDITAR_ELIMIANR implements AsyncCallback<Void>{
        public void onSuccess(Void result) {
            Visor.show("ServletRPTFoliosXUnidad");
            window.hide();
        }
    ...
    private class EVENTO_BOTON_GRID extends SelectionListener<ButtonEvent>{
        ...
        public void componentSelected(ButtonEvent ce){
            ...
            System.out.println("ce.getButton().getBaseStyle():"+ce.getButton().getBaseStyle());
            System.out.println("ce.getButton().getId():"+ce.getButton().getId());
            System.out.println("ce.getButton().getItemId():"+ce.getButton().getItemId());
            System.out.println("ce.getButton().getMenuAlign():"+ce.getButton().getMenuAlign());
            System.out.println("ce.getButton().getStateId():"+ce.getButton().getStateId());
            System.out.println("ce.getButton().getStyleName():"+ce.getButton().getStyleName());
            System.out.println("ce.getButton().getStylePrimaryName():"+ce.getButton().getStylePrimaryName());
            System.out.println("ce.getButton().getText():"+ce.getButton().getText());
            System.out.println("ce.getButton().getTitle():"+ce.getButton().getTitle());
            System.out.println("ce.getButton().getType():"+ce.getButton().getType());
            System.out.println("ce.getButton().toString():"+ce.getButton().toString());
