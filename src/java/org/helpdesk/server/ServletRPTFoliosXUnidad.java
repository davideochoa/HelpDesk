 ...
 */
public class ServletRPTFoliosXUnidad extends HttpServlet {
    @Override
    public void service(HttpServletRequest req, HttpServletResponse response) throws ServletException, IOException{
        ...
        try{
           ...
           JasperReport jasperReport  = (JasperReport)JRLoader.loadObject("C:/reportes/HelpDeskRPTFoliosXUnidad.jasper");
           ...
           response.setHeader ("Content-disposition", "inline; filename=HelpDeskRPTFoliosXUnidad.pdf");
