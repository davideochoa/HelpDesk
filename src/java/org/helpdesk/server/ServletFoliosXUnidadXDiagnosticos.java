 ...
 */
public class ServletFoliosXUnidadXDiagnosticos extends HttpServlet {
    @Override
    public void service(HttpServletRequest req, HttpServletResponse response) throws ServletException, IOException{
        ...
        try{
           ...
           JasperReport jasperReport  = (JasperReport)JRLoader.loadObject("C:/reportes/HelpDeskRPTFolioXUnidadXDiagnostico.jasper");
           ...
           response.setHeader ("Content-disposition", "inline; filename=HelpDeskRPTFolioXUnidadXDiagnostico.pdf");
